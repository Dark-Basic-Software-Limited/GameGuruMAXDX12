...
| `UNDO` / `REDO` | (none) | Invoke the editor's undo/redo entry points (`undosys_undoevent`/`undosys_redoevent`) — same as Ctrl+Z / Ctrl+Y. Pairs with SCULPT_TEST/PAINT_TEST to verify + clean up synthetic edits |
