...
| `SET_GPUPARM` | `<0\|1\|2>` | Pin the gpup update arm: 0 stock (FPS-dependent branch at 7.143ms/140 FPS), 1 force whole-batch, 2 force split (needs 2+ emitters). Both arms are rate-fair long-run; the lever exists to A/B cadence-granularity effects at one FPS |
