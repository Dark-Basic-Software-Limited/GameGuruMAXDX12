...
- ★★★ **[Terrain Bake / Water Bake](project_terrain_bake.md)** — the 3.25 milestone: terrain → plain meshes + BC1 two-tier, Water Bake, Reduction Scale, per-level Brutal switches. ★ Eleven silent defects — 3.73: the bake DELETED every near 3D tree (the pool was hosted inside the terrain's update, which returns early forever once the terrain is torn down) — read its rules before touching a custom draw, a bake, or removing a component. AMD round detail: notes §3.25.
